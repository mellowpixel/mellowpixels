...
;(function($) {
   ...
   'use strict'
	...
	var responsiveMenu = function() {
		...
		$('.btn-menu.black').on('click', function() {
			$('#mainnav-mobi').slideToggle(300);
			$(this).toggleClass('active');
		});
	...
	var progressBar = function() {
 	...
 	var headerFixed = function() {
 			if( $('#front-screen-logo').length >0 && $('#front-screen-logo').length > 0 ){
	 			var img_a = document.getElementById('front-screen-logo'),
					img_height_a = img_a.clientHeight,
					windowHeight_a = $(window).innerHeight(),
					img_margin_top_a = (windowHeight_a / 2) - (img_height_a / 2) + 50;

				var headerFix = img_margin_top_a;
